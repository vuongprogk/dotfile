...
function M.foldtext()
	...
	table.insert(ret, { " " .. Ace.config.icons.misc.dots })
...
function M.statuscolumn()
	...
	local show_open_folds = vim.g.vim_statuscolumn and vim.g.vim_statuscolumn.folds_open
	local use_githl = vim.g.vim_statuscolumn and vim.g.vim_statuscolumn.folds_githl
	...
	if show_signs then
		...
		vim.api.nvim_win_call(win, function()
			...
			elseif
				show_open_folds
				and not Ace.ui.skip_foldexpr[buf]
