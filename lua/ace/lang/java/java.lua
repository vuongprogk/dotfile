if Ace.config.executable.java then
	...
	return {
			...
			config = function(_, opts)
				...
				local function attach_jdtls()
					...
					local config = extend_or_override({
						...
						capabilities = Ace.has("cmp-nvim-lsp") and require("cmp_nvim_lsp").default_capabilities()
							or nil,
					}, opts.jdtls)
		...
		},
		{
			...
			opts = {
				...
				setup = {
					jdtls = function()
						local is_maven_project = vim.fs.find({
							"build.gradle",
							"build.gradle.kts",
							"build.xml", -- Ant
							"pom.xml", -- Maven
